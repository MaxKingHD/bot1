...
var fortunes = ["There is a true and sincere friendship between you and your friends.",
...
fortuneToUse = fortunes[Math.floor(Math.random() * fortunes.length)];


let fEmbed = new discord.RichEmbed()
.setDescription("• Generic fortune cookie fortunes •")
.addField("• You open up your fortune cookie and read...", "```" + fortuneToUse + "```")
.setColor("RANDOM")
